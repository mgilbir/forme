...
// bidi/bidi.go declares its constants.
//
...
// bracket is one half of a bracket pair: the character that closes or opens
...
// brackets is every character with a Bidi_Paired_Bracket_Type of Open or
...
// mirrorPair is a character and the one drawn in its place in a
// right-to-left run.
type mirrorPair struct{ from, to rune }

// mirrors is the Bidi_Mirroring_Glyph property, sorted by code point: rule
