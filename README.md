...
| | |
|---|---|
| **CSS Working Group reftests** | 6,253 documents rendered and compared against their references — **5,964 pass with nothing unsupported reported in either document** |
...
Beyond the suites: 22 fuzz targets, seventeen of them scheduled weekly, a
