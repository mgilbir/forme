...
| | |
|---|---|
| **CSS Working Group reftests** | 6,253 documents rendered and compared against their references — **5,970 pass with nothing unsupported reported in either document** |
...
Beyond the suites: 23 fuzz targets, eighteen of them scheduled weekly, a
