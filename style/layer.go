...
//
// An @import carrying layer() is not read, because @import itself is not. A
// revert-layer value is not implemented and is reported where every unknown
// value is. Neither is a quiet narrowing: one is a rule this engine does not
// fetch and the other a value it says it does not know.
